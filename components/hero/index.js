...
import { HeroContainer, ButtonWithStyle, ButtonNoStyle } from "./style.styled";
import { Typography } from "@mui/material";

const Hero = () => {
  return (
    <HeroContainer style={{ position: "relative" }}>
      <Container className="flex flex-wrap mt-[90px]">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              MIND <span>EXPLORE</span>
            </h1>
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              NEW WORLD
            </h1>
            <p className="py-7 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
            ...
            <div className="mb-[66px] flex flex-row">
              <a
                href="#"
                rel="noopener"
                className="text-lg font-medium text-center text-white"
              >
                <ButtonWithStyle>BUY NOW</ButtonWithStyle>
              </a>
              <a
                href="#"
                rel="noopener"
            ...
            <div className="flex flex-row gap-[31px]">
              <div className="flex flex-col items-center justify-center gap-1">
                ...
                <Typography>Unique Style</Typography>
              </div>
              <div className="flex flex-col items-center justify-center gap-1">
                <Typography variant="h2"><span>200+</span></Typography>
                <Typography>Project finished</Typography>
              </div>
              <div className="flex flex-col items-center justify-center gap-1">
